...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#1a1410", color: "#F5E6C8", fontFamily: "DM Sans, sans-serif", overflow: "hidden" }}>
      ...
      {page !== "home" && <img src="/mascot.png" alt="" style={{ position: "fixed", bottom: 12, right: 12, width: 90, height: "auto", opacity: 0.2, pointerEvents: "none", zIndex: 10, filter: "drop-shadow(0 2px 8px rgba(0,0,0,0.4))" }} />}
